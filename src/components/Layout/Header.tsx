...
const Header: React.FC = () => {
  ...
  return (
    <header className="h-16 bg-white/90 dark:bg-gray-900/50 backdrop-blur-sm border-b border-gray-200 dark:border-gray-800/50 flex items-center justify-between px-6">
      ...
      {user && (
        <div className="flex items-center space-x-4">
          ...
          <button
            ...
            className="flex items-center space-x-2 px-3 py-2 text-sm bg-gray-100 dark:bg-gray-800 hover:bg-gray-200 dark:hover:bg-gray-700 rounded-lg transition-colors text-gray-700 dark:text-white"
          >
