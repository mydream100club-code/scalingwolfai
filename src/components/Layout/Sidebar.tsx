...
const Sidebar: React.FC = () => {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <div className={`fixed left-0 top-16 h-[calc(100vh-4rem)] bg-white/90 dark:bg-gray-900/50 backdrop-blur-sm border-r border-gray-200 dark:border-gray-800/50 transition-all duration-300 z-50 ${
        ...
        <button
          onClick={toggleSidebar}
          className="absolute -right-3 top-4 w-6 h-6 bg-gray-200 dark:bg-gray-800 hover:bg-gray-300 dark:hover:bg-gray-700 rounded-full flex items-center justify-center transition-colors"
        >
                      ...
                      <Link
                        ...
                        className={`block px-3 py-2 text-sm rounded-lg transition-all duration-200 ${
                          isActive(child.path)
                            ...
                            : 'text-gray-500 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white hover:bg-gray-100 dark:hover:bg-gray-800/30'
                        }`}
                      >
                        {child.label}
                      </Link>
