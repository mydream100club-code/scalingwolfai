...
const Signup: React.FC = () => {
  ...
  const roles: { value: UserRole; label: string; description: string }[] = [
    ...
    { value: 'setter', label: 'Setter', description: 'Lead generation access' },
    { value: 'closer', label: 'Closer', description: 'Sales and documents access' },
      ...
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <div className="space-y-2">
            ...
            <p className="text-gray-600 dark:text-gray-400">Join Vertical Systems and start managing your agency</p>
          </div>
        </div>
        ...
        <div className="glass-card p-8">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-3 bg-white dark:bg-gray-800/50 border border-gray-300 dark:border-gray-700 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-transparent text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 transition-all duration-200"
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <Phone className="absolute left-3 top-1/2 transform -translate-y-1/2 h-5 w-5 text-gray-500 dark:text-gray-400" />
                <input
                  id="phone"
                  name="phone"
                  type="tel"
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <Briefcase className="absolute left-3 top-1/2 transform -translate-y-1/2 h-5 w-5 text-gray-500 dark:text-gray-400" />
                <input
                  id="jobTitle"
                  name="jobTitle"
                  type="text"
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <Shield className="absolute left-3 top-1/2 transform -translate-y-1/2 h-5 w-5 text-gray-500 dark:text-gray-400" />
              ...
              <select
                  ...
                  value={formData.role}
                  onChange={handleChange}
                  className="w-full pl-10 pr-4 py-3 bg-white dark:bg-gray-800/50 border border-gray-300 dark:border-gray-700 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-transparent text-gray-900 dark:text-white transition-all duration-200"
                  required
                >
                  <option value="" className="text-gray-500 dark:text-gray-400">Select your role...</option>
                  {roles.map((role) => (
                    <option key={role.value} value={role.value} className="text-gray-900 dark:text-white">
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  onChange={handleChange}
                  className="w-full pl-10 pr-12 py-3 bg-white dark:bg-gray-800/50 border border-gray-300 dark:border-gray-700 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-transparent text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 transition-all duration-200"
